        ...
        <div className="featured">
            <div className="featuredItem">
                ...
                <div className="featuredMoneyContainer">
                    <span className="featuredMoney">$ 34567</span>
            ...
            <div className="featuredItem">
                ...
                <div className="featuredMoneyContainer">
                    <span className="featuredMoney">$ 344567</span>
                    <span className="featuredMoneyRate">61.4<ArrowUpward className="featuredIcon"/></span>
